            ...
            <div class="container">
                ...
                <section style="padding-top: 60px">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 offset-md-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{url('/infractions-import')}}" method="post"  enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <label for="infractionsFile">Selection</label>
                                                <input type="file" class="form-control" name="infractionsFile">
                                                <b>Attention : <b class="text-danger" style="font-size: 30px">*</b>
                                                    Le fichier doit etre d'extention xlsx, xls ou csv
                                                </b>
                                            </div>
                                            @error('infractionsFile')
                        ...
                        <hr class="pb-2 mt-5" style="background-color: #6698FF">

                        <div class="row">
                            @if(Session::has('success'))
                                <div class="alert alert-success" role="alert">{{Session::get('success')}}</div>
                            @endif
                            <div class="col-md-12"><h3 class="text-center pt-4">Listes des Infractions</h3></div>
                            <div class="col-md-12">

                                <hr class="pb-1 mt-3 mb-3" style="background-color: #6698FF">
                                <table class="table">
                                    <thead>
                                    <tr>
